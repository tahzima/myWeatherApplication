...
class WeatherProvider with ChangeNotifier {
  ...
  Future<void> getDailyWeather(LatLng location) async {
    ...
    Uri dailyUrl = Uri.parse(
      'https://api.openweathermap.org/data/3.0/onecall?lat=${location.latitude}&lon=${location.longitude}&units=metric&exclude=minutely,current&appid=8bc1f9f18433660632232c660b998be9',
    );
    try {
